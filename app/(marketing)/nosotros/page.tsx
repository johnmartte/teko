      ...
      <div className="relative mx-auto max-w-[1200px]">
        ...
        <div data-reveal="" className="mt-8 max-w-[760px]">
          ...
          <h1 className="mt-5 text-[clamp(36px,5vw,58px)] font-semibold leading-[1.02] tracking-[-0.035em]" style={{ textWrap: "balance" }}>
            ...
            <em style={{ fontFamily: "'Instrument Serif', Georgia, serif", fontStyle: "italic", fontWeight: 400, color: "#bfe9ff" }}>integral</em>
          </h1>

          <p className="mt-5 max-w-[520px] text-[15.5px] font-light leading-[1.6]" style={{ color: "rgba(242,243,245,0.62)" }}>
            Somos un equipo apasionado por construir productos digitales que generan resultados reales. Trabajamos con startups, negocios establecidos y emprendimientos en US y LATAM.
          </p>
        </div>
      </div>
    </section>
